		...
		mNextButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				if (mPager.getCurrentItem() == mCurrentPageSequence.size() - 1) {
					...
					profile.name = bundle.getBundle(
							ProfileWizardModel.STEP_NAME).getString(
							Profile.NAME);
					profile.birthday = bundle.getBundle(
							ProfileWizardModel.STEP_BIRTHDATA).getInt(
							Profile.BIRTHDAY);
					profile.height = bundle.getBundle(
							ProfileWizardModel.STEP_BIRTHDATA).getFloat(
							Profile.HEIGHT);
					profile.weight = bundle.getBundle(
							ProfileWizardModel.STEP_BIRTHDATA).getFloat(
							Profile.WEIGHT);
					profile.gender = bundle.getBundle(
							ProfileWizardModel.STEP_GENDER).getInt(
							Profile.GENDER);
					profile.pic = bundle.getBundle(
							ProfileWizardModel.STEP_AVATAR).getParcelable(
							Profile.AVATAR);
					profile.save();
					finish();
				} else {
